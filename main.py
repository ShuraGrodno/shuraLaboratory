...
img=cv2.imread('Face.jpg') # Загрузить изображение в черно-белом цвете
# img = cv2.resize(img, (img.shape[1] // 2, img.shape[0] // 2)) # Увеличить или уменьшить изображение
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY) # преобразование изображения в черно-белый цвет
...
rezult=faces_detect.detectMultiScale(gray, 1.1, 3)
